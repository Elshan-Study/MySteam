...
public static class MenuManager
{
        ...
        while (true)
        {
            ...
            switch (input)
            {
                ...
                default:
                    ...
                    //dd anonymous user or guest mode handling
                    Console.ReadKey();
                    break;
            }
        }
    }
    private static bool RegistrationMenu()
    {
        Console.Clear();
        ...
        {
            Console.WriteLine("Login must be at least 3 characters and contain only letters, numbers, dashes or " +
                              "underscores.");
            Console.ReadKey();
            return false;
        }
    ...
    private static bool LoginLogoutMenu()
    {
        Console.Clear();
